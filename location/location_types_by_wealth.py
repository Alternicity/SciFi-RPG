...
# Define minimum types of locations, per region,  by wealth level of that region
    location_types_by_wealth = {
        ...
        "Rich": [(CorporateStore, 1), (Museum, 1), (Library, 1), (Shop, 1), (ElectricalWorkshop, 1), (PoliceStation, 1), (SportsCentre, 1), (House, 1), (HQ, 4), (Park, 1), (ApartmentBlock, 1), (ResearchLab, 1), (Cafe, 1), (Restaurant, 3)],
