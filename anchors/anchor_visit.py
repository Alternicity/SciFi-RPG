...
class VisitToRobAnchor(VisitAnchor):
    ...
    def compute_salience_for(self, percept_data: Any, npc) -> float:
        ...
        location = percept.get("object")#really? why location here? And is it even used below?
        obj = percept_data.get('name')
        ...
        #calculating scor rather salience per object in percepts or memory?
